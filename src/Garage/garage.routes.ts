...
import { login, findAll, findOne, update, add, eliminate, sanitizeGarageInput, getAvailables } from "./garage.controller.js";
...
GarageRouter.get('/:cuit', auth, findOne)
GarageRouter.post('/login', login)
