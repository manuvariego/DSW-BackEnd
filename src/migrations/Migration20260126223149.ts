...
export class Migration20260126223149 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`reservation\` (\`id\` int unsigned not null auto_increment primary key, \`date_time_reservation\` datetime not null, \`check_in_at\` datetime not null, \`check_out_at\` datetime not null, \`estado\` varchar(255) not null default 'activa', \`amount\` int not null, \`vehicle_license_plate\` varchar(255) not null, \`garage_cuit\` int unsigned not null, \`parking_space_number\` int unsigned not null, \`parking_space_garage_cuit\` int unsigned not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`reservation_services\` (\`reservation_id\` int unsigned not null, \`service_id\` int unsigned not null, primary key (\`reservation_id\`, \`service_id\`)) default character set utf8mb4 engine = InnoDB;`);
